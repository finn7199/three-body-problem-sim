...
#include "Camera.h" // Include the new camera
...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        processInput(window);
        // --- New Fixed Timestep Physics Loop ---
        accumulator += deltaTime;
        while (accumulator >= FIXED_TIMESTEP) {
            simulation.update(FIXED_TIMESTEP); // Always update with the small, fixed step
        ...
        // --- Activate, configure, and draw with sphere shader ---
        sphereShader.use();
